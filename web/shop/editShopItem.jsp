...
%>
    <div class="container mt-3">
        ...
        <table class="table" >
            ...
            <tr>
                <td> NAME : </td>
                <td> <input type="text" value="<%=student.getName()%>" name="st-na"></td>
            </tr>
            <tr>
                <td>SURNAME : </td>
                <td> <input type="text" value="<%=student.getSurname()%>" name="st-su"></td>

            </tr>
            <tr>
                <td>BIRTHDATE : </td>
                <td><input type="date" value="<%=student.getBirthdate()%>" name="st-bi"></td>
            </tr>
            <tr>
                <td>CITY : </td>
                <td><select name="st-ci" class="form-select">
                    <%

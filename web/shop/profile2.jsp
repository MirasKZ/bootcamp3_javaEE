...
<!-- Modal -->
<div class="modal fade" id="addShopItemModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">New shop item</h1>
            ...
            <div class="modal-body">
                <form action="/shopadditem" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success ">ADD SHOP ITEM</button>
                    </div>
                </form>
            </div>
    ...
    if(shopitems!=null){
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    %>
                    <!-- Product image-->
                    <img class="card-img-top" style="width: 250px;height: 220px;align-self: center" src="<%=sh.getUrl()%>" alt="..." />
                    <!-- Product details-->
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        ...
                        <div class="text-center mt-1 "><a class="btn btn-secondary"  href="/shopdetails?id=<%=sh.getId()%>">Details</a></div>
                    </div>
                </div>
            </div>
            </form>
...
<footer class="py-5 bg-dark">
    <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Smart Shop 2022</p></div>
</footer>
<!-- Bootstrap core JS-->
